 ...
 */
public class KalaListRowFragment extends AListRowFragment<KalaModel> {
    private static final String TAG = "KalaListRowFragment";
    ...
    private class KalaAdapter extends MyAdapter {
        ...
        public int getLayout() {
            return R.layout.fragment_kala_list_row;
        }
